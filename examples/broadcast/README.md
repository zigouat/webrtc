# broadcast
broadcast is a WebRTC application that demonstrates how to broadcast a video to many peers, while only requiring the broadcaster to upload once.
...
## Instructions
### Download broadcast
clone the project. and cd into the examples directory.
...
* Run `curl localhost:9000 -d "$BROWSER_OFFER"`. `$BROWSER_OFFER` is the value you copied in the last step.
